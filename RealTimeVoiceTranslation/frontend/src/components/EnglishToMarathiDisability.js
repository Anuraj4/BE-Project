...
const EnglishToMarathiDisability = () => {
  ...
  // Voice Commands for controlling the actions
  const startStopRecording = (command) => {
...
export default EnglishToMarathiDisability;
